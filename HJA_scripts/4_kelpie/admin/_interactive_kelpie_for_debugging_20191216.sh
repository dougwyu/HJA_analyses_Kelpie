...
singularity exec --bind /gpfs/home/b042/scripts:/scripts --bind /gpfs/scratch/b042:/mnt ~/ubuntukelpie.sif /scripts/Kelpie_v2.0.4/ubuntu-16.04/Kelpie_v2 -h
...
singularity exec --bind /gpfs/home/b042/scripts:/scripts --bind /gpfs/scratch/b042:/mnt ~/ubuntukelpie.sif /scripts/Kelpie_v2.0.4/ubuntu-16.04/Kelpie_v2 -f CCHGAYATRGCHTTYCCHCG -r TCDGGRTGNCCRAARAAYCA -unfiltered -strict -min 400 -max 440 -tmp /mnt SM-PG-M1-S2_BDSW190603195-1a/SM-PG-M1-S2_BDSW190603195-1a_?_val_?.fq SM-PG-M1-S2_BDSW190603195-1a/SM-PG-M1-S2_BDSW190603195-1a.fas
