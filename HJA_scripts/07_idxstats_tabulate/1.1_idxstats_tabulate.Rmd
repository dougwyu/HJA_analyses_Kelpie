...
# topo.df
topo <- topo.df %>% 
    separate(uniqueID, into = c("site", "trap", "period"), sep = "_") %>% 
    select(-trap, -period) %>% 
...
# write_csv(envdataGISMSLidar, file.path("..", "10_eo_data", "envdataGISMSLidar_missing_6_sites_20210131.csv"))
```
...
### lulu.  
I ran lulu on the kelpie_20200214_BF3BR2_derep_filtered_geneious_vsearch97_min2.fas OTUs, and lulu removed no OTUs.  So it looks like Kelpie + vsearch97 produces separate OTUs, and lulu does not help. Thus, I do not run this code.  It is here for archival purposes. 
