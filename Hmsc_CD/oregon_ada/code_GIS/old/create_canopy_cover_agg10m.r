...
## get 10 resolution raster with mean of 1m raster
# ht_gt4_r10 <- aggregate(ht_gt4_utm, fact = 10, fun = mean, expand = FALSE,
#                          filename = file.path(gis, "ht_gt4_r10.tif"), datatype = "FLT4S", overwrite = TRUE)
# 

ht_gt4_r10 <- raster(file.path(gis, "ht_gt4_r10.tif"))
# plot(ht_gt4_r10)
# rm(ht_gt4_r30); gc()
# 

d250 <- (focalWeight(ht_gt4_r10, d = 250, type = "circle")>0)*1
d500 <- (focalWeight(ht_gt4_r10, d = 500, type = "circle")>0)*1

# do focal over 250 windows
ht_gt4_r10_f250 <- focal(ht_gt4_r10, w = d250, fun = function(x) sum(x)/sum(x!=0), pad = TRUE, padValue = 0,
                   filename = file.path(gis, "ht_gt4_r10_f250.tif"), datatype = "FLT4S")


ht_gt4_r10_f500 <- focal(ht_gt4_r10, w = d500, fun = function(x) sum(x)/sum(x!=0), pad = TRUE, padValue = 0,
                         filename = file.path(gis, "ht_gt4_r10_f500.tif"), datatype = "FLT4S")


# ht_gt4_r10_f250 <- raster(file.path(gis, "ht_gt4_r10_f250.tif"))
# ht_gt4_r10_f250
# plot(ht_gt4_r10_f250)
# hist(ht_gt4_r10_f250)
# 
# ht_gt4_r10_f500 <- raster(file.path(gis, "ht_gt4_r10_f500.tif"))
# plot(ht_gt4_r10_f500)
# 
# plot(stack(ht_gt4_r10_f250,ht_gt4_r10_f500))
# do focal windows of 250 and 500 m radius - but based on 30m resolution template.
# get coordinates at 30m resolution grid
# xy_r30 <- coordinates(r30)
# 
...
# writeRaster(gt4_r250, filename = file.path(gis, "gt4_r250.tif"), datatype = "FLT4S", overwrite = TRUE)
