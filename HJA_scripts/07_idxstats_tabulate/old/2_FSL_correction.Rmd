...
# HOBO-317_M1_S1 is an extra line in lysis_buffer_volume_20200724.csv, but not in OTU table. this sample should be deleted because it is not in my shotgunned samples (possibly a failed sample at Earlham)
...
colselect <- function(inputdf) {
  ...
  select(-lysisBufferml, -aliquot, -lysis_ratio, -COISpikeElaterid,
         -COISpikeMordellid, -spike_wt_mean, -lysis_batch, -site_trap_period) %>%
