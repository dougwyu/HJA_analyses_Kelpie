...
cd ~/Dropbox/Working_docs/Luo_Mingjie_Oregon/HJA_analyses_Kelpie/HJA_scripts/05_taxonomy/kelpie_20200916_BF3BR2/

vsearch --usearch_global kelpie_20200916_BF3BR2_derep_filter3_vsearch97_rmdup_spikes.fas --db kelpie_20200916_BF3BR2_derep_filter3_vsearch97_rmdup_spikes.fas --self --id .84 --iddef 1 --userout match_list.tsv -userfields query+target+id --maxaccepts 0 --query_cov .9 --maxhits 10
```


```{r}
match_list <- read_delim(file.path("..", "05_taxonomy", "kelpie_20200916_BF3BR2", "match_list.tsv"), "\t", escape_double = FALSE, col_names = FALSE, trim_ws = TRUE)
...
otuhist <- hist(species$occurrences, breaks = 200)
