...
otu.env1.noS = read.csv(here('..','..','Kelpie_maps','sample_by_species_table_F2308_minimap2_20200221_kelpie20200214.csv'), header=T, sep=',', stringsAsFactors = F, na.strings='NA')
	
otu.env1.spike = read.csv(here('..','..','Kelpie_maps','sample_by_species_corr_table_F2308_minimap2_20200221_kelpie20200214.csv'), header=T, sep=',', stringsAsFactors = F, na.strings='NA')
...
otu.env1.noS.rel.abun = read.csv(here('kelpie','formatted_data','relAbun_lidar_sample_by_species_table_F2308_minimap2_20200221_kelpie20200214.csv'), header=T, sep=',', stringsAsFactors = F, na.strings='NA')
