...
# pdf(here('R','graph','describe_lidar_indices.pdf'), height=4, width=9)
par(mfrow=c(1,2))
...
# write.table(otu2, file=here('kelpie','formatted_data','present_lidar_mulspec_sample_by_species_corr_table_F2308_minimap2_20200221_kelpie20200214.csv'), sep=',',row.names=F)
	
# write.table(otu2, file=here('kelpie','formatted_data','relAbun_lidar_mulspec_sample_by_species_corr_table_F2308_minimap2_20200221_kelpie20200214.csv'), sep=',',row.names=F)
...
# . NMDS  .
#pdf(here('R','graph',paste(pdf.name)), width=15, height=15)
...
#pdf(here('R','graph',paste(pdf.text)), width=11, height=11)
...
#pdf(here('R','graph',paste(pdf.text)), width=18, height=12)
par(mfrow=c(2,3))
...
#... Procrustes: rmse 0.0004416068  max resid 0.003395293 (87516)
...
#  ... Procrustes: rmse 0.0009067094  max resid 0.003763488
...
#pdf(here('R','graph','nmds_geo_lidar_s1m1_present.pdf'), width=15, height=15)
...
#  Procrustes: rmse 0.0002273249  max resid 0.001038094 
...
#   Procrustes: rmse 0.00119641  max resid 0.006656238
