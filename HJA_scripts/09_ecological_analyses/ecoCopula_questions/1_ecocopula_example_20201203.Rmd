...
1. offset(log(spikeins)) or do what i do, which is divide by spike in reads
2. mvabund requires integers
4. Or should i use stackedsdm?  needs manual coding to make it work for this.  thus, use mvabund
