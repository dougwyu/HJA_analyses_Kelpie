...
interactive # 24 cores
    # equivalent to: srun -n1 -p compute-24-96 -J interactive --time=12:00:00 --mem=4G --pty bash
squeue -u b042
...
seqkit stats kelpie_${timestamp}.fas # 1,233,584 seqs BF3BR2 2.0.10
...
cd ~/_Oregon/2019Sep_shotgun/2.trimmeddata/
...
seqkit stats kelpie_${timestamp}_discards.fas # 16,455 seqs BF3BR2 2.0.10 # 12,883 BF3BR2 seqs kelpie 2.0.8; 10,962 LERAY seqs 2.0.8
