...
writeRaster(rStack.sum, filename = file.path(resFolder, "spSum.tif", datatype = "FLT4S"))
writeRaster(spRich, filename = file.path(resFolder, "spRich_all.tif", datatype = "FLT4S"))
