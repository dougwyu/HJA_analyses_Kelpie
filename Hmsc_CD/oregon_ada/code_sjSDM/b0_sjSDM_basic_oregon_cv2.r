...
tune_results_old_vars = sjSDM_cv(Y = otu.pa.minocc,
                        ...
                        tune_steps = 3L, # 20L is default - is this the number of tunes for random search??? 
                        alpha_cov = 0.5, # species regularisation
                        alpha_coef = c(0,0.5,1.0), # env reg
...
# save results
save(tune_results_new_vars, best_new_vars,tune_results_old_vars, best_old_vars, file ="results_sjSDM/oregon_trial_tune_cv2.rdata")



# visualize tuning and best points:
pdf(file = "results_sjSDM/oregon_tune_trial_cv2_old.pdf")
plot(tune_results_old_vars, perf = "logLik")
dev.off()

pdf(file = "results_sjSDM/oregon_tune_trial_cv2_new.pdf")
