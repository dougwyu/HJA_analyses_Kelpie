...
## get best tune run
pa <- read.csv(file.path(resFolder, "manual_tuning_sjsdm_5CV_M1S1_mean_AUC_pa_min_5_nSteps_1000.csv"))
head(pa)
...
### Plots 
pdf(file.path(resFolder, "eval_metrics_pairs_test.png"))
plot(sp.res.test[[1]])
mtext("test")
dev.off()
...
pdf(file.path(resFolder, "eval_metrics_auc_test_train.png"))
