...
set.seed(999)
# subset no of observations
rKeep <- sample(1:nrow(Y.train), size = 75, prob = rich^2) ## WORKS with size = 50
...
# Subset no of species ## WORKS with 15 species
Y.train <- Y.train[,sample(seq_along(Y.train), size = 25, prob = prev^2)] # samples biased to higher prevalence
