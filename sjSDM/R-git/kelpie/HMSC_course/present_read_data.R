...
# READING IN SXY: study design (S) and/or covariates (X) and species data (Y) #setwd("/media/yuanheng/SD-64g2/files/Projects/HMSC-R/oregon-data/HMSC_course")
	
SXY = read.csv('present_lidar_mulspec_5_sample_by_species_corr_table_F2308_minimap2_20200221_kelpie20200214.csv', header=T, sep=',', stringsAsFactors = F, na.strings='NA') 	
