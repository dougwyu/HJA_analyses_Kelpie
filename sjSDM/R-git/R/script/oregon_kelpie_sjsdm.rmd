...
scale.env1 = dataI.1.spike.rel.abun2[,c('elevation.scale','canopy.ht.scale','min.T.scale','max.T.scale','precipilogLik(sjsdm.s1_m1_spike.relAbun)tation.scale','metre.road.scale','metre.stream.scale','yrs.disturb.min.scale')]
...
sjsdm.s1_m1_spike.relAbun = sjSDM(
	...
	env = linear(data = as.matrix(scale.env1), formula = ~ elevation.scale+canopy.ht.scale+min.T.scale+max.logLik(sjsdm.s1_m1_spike.relAbun)T.scale+precipitation.scale+metre.road.scale+metre.stream.scale+yrs.disturb.min.scale,
...
```{r sjsdm-analyse-correlation (old version)}
...
```{r model-analyse-polygon (old version)}
# model result from old sjsdm version
# don't bother to run! just for backup!
# ..... Polygon Drawing .....
# . species association .
...
```{r model-analyse-polygon-envir (old version)}
# model result from old sjsdm version
# don't bother to run! just for backup!
# ..... environmental effect .....
# Drawing parameter of OTU and environmental covariant
