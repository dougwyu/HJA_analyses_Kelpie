...
do
	...
	minimap2 -ax sr ~/_Oregon/2019Sep_shotgun/reference_seqs/kelpie_20200214_BF3BR2_derep_filtered_geneious_vsearch97_min2_spikes.fas ${sample}_1_val_1.fq.gz ${sample}_2_val_2.fq.gz | samtools sort -@15 - -o ${sample}_sorted.bam # skip the samtools view -b step
