...
otu.mod4 <- manyglm(otu.ord ~ 1 + offset(log(offset)), 
...
# with elevation
otu.mod5 <- manyglm(otu.ord ~ elevation_m + offset(log(offset)), 
                    family = "negative.binomial", 
                    data = env.csv
                    )
...
otu.mod6 <- manyglm(otu.ord ~ elevation_m + insideHJA + lg_YrsDisturb + offset(log(offset)), 
                    family = "negative.binomial", 
                    data = env.csv,
                    show.time = "all"
                    )
plot(otu.mod6) # chk residuals
anova(otu.mod6, nBoot = 200) 
  # Time elapsed: 0 hr 22 min 7 sec
  # Analysis of Deviance Table
  # 
  # Model: otu.ord ~ elevation_m + insideHJA + lg_YrsDisturb + offset(log(offset))
  # 
  # Multivariate test:
  #               Res.Df Df.diff   Dev Pr(>Dev)   
  # (Intercept)       87                          
  # elevation_m       86       1 423.4    0.005 **
  # insideHJA         85       1 591.9    0.060 . 
  # lg_YrsDisturb     84       1 497.4    0.284   
  # ---
  # Signif. codes:  0 ‘***’ 0.001 ‘**’ 0.01 ‘*’ 0.05 ‘.’ 0.1 ‘ ’ 1
  # Arguments:
  #  Test statistics calculated assuming uncorrelated response (for faster computation) 
  #  P-value calculated using 200 iterations via PIT-trap resampling.
