...
# ideally, there should be 1213 in all rows of column "n" 
# 1213 == 1211 species + 2 spike-in species
...
species <- select(idx_meta_genomecov_filtered_wide, starts_with(c("R96__", "R1829-2")))
