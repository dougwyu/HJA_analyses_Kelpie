...
minocc <- 10 # set to high number (e.g. 20) for testing
...
env.csv <- otuenv %>% 
    ...
    select(SiteName, trap, period, lysis_ratio, COISpike_sum, clearcut, insideHJA, oldGrowthIndex, elevation_f, canopyHeight_f, minT_annual, maxT_annual, precipitation_mm, be10:cut.r1k.pt, mean.NDVI, mean.EVI, mean.green, mean.wet, l_p25, l_p95, l_rumple, contains("20180717"), lg_DistStream, lg_DistRoad, lg_YrsDisturb, lg_cover2m_max, lg_cover2m_4m, lg_cover4m_16m) %>%
...
names(env.csv)
#  [1] "SiteName"         "trap"             "period"          
#  [4] "lysis_ratio"      "COISpike_sum"     "offset"          
#  [7] "clearcut"         "insideHJA"        "oldGrowthIndex"  
# [10] "elevation_f"      "canopyHeight_f"   "minT_annual"     
# [13] "maxT_annual"      "precipitation_mm" "be10"            
# [16] "tri"              "slope"            "aspect"          
# [19] "Nss"              "Ess"              "twi"             
# [22] "ht"               "ht.r250"          "ht.r500"         
# [25] "ht.r1k"           "cov2_4"           "cov2_4.r250"     
# [28] "cov2_4.r500"      "cov2_4.r1k"       "cov4_16"         
# [31] "cov4_16.r250"     "cov4_16.r500"     "cov4_16.r1k"     
# [34] "be500"            "mTopo"            "cut.r1k.pt"      
# [37] "mean.NDVI"        "mean.EVI"         "mean.green"      
# [40] "mean.wet"         "l_p25"            "l_p95"           
# [43] "l_rumple"         "B1_20180717"      "B2_20180717"     
# [46] "B3_20180717"      "B4_20180717"      "B5_20180717"     
# [49] "B6_20180717"      "B7_20180717"      "B10_20180717"    
# [52] "B11_20180717"     "NDVI_20180717"    "EVI_20180717"    
# [55] "B_20180717"       "G_20180717"       "W_20180717"      
# [58] "lg_DistStream"    "lg_DistRoad"      "lg_YrsDisturb"   
# [61] "lg_cover2m_max"   "lg_cover2m_4m"    "lg_cover4m_16m"
```
...
phist <- ggplot(sp_res, aes(x = Factor1)) +
  geom_histogram() 
phist
...
# with old vars
otu.mod3 <- manyglm(otu.ord ~ insideHJA + elevation_f + canopyHeight_f +
                      minT_annual + precipitation_mm + lg_DistRoad +
                      lg_DistStream + lg_YrsDisturb + 
                      B1_20180717 + B2_20180717 + B3_20180717 + B4_20180717 + 
                      B5_20180717 + B6_20180717 + B7_20180717 + B10_20180717 + 
                      B11_20180717 + NDVI_20180717 + EVI_20180717 + B_20180717 +
                      G_20180717 + W_20180717 + lg_cover2m_max + lg_cover2m_4m +
                      lg_cover4m_16m + l_p25 + l_p95 + l_rumple + offset(log(COISpike_sum)), 
                    family = "negative.binomial", 
                    data = env.csv
                    )
...
# new vars
otu.mod6 <- manyglm(otu.ord ~ be10 + insideHJA + tri + slope + Nss + Ess + ht +
                      ht.r250 + ht.r500 + ht.r1k + cov2_4 + cov2_4.r250 +
                      cov2_4.r500 + cov2_4.r1k + cov4_16 + cov4_16.r250 +
                      cov4_16.r500 + cov4_16.r1k + be500 + mTopo +
                      cut.r1k.pt + minT_annual + maxT_annual + 
                      precipitation_mm + lg_DistStream + lg_DistRoad +
                      lg_YrsDisturb + B1_20180717 + B2_20180717 + 
                      B3_20180717 + B4_20180717 + B5_20180717 + B6_20180717 +
                      B7_20180717 + B10_20180717 + B11_20180717 + 
                      NDVI_20180717 + EVI_20180717 + B_20180717 + 
                      G_20180717 + W_20180717 + l_p25 + l_rumple +
...
# OR
# mod3: old vars 
cordord <- "otu.mod3.ord"; model <- "otu.ord ~ old vars"
# OR
# mod6: new vars 
cordord <- "otu.mod6.ord"; model <- "otu.ord ~ new vars"
...
p0
p1 | p2 # if error "Viewport has zero dimension(s)" error, enlarge plot window
