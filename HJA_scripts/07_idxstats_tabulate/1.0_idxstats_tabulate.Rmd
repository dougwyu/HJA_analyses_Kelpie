...
(idxstatsgenomecovfolder <- paste0("outputs_F2308_f0x2_", samtoolsqual, "_minimap2_outputs_20200922_kelpie_20200916_LERAY_derep_filter3_vsearch97_rmdup_spikes"))

# this is where i store the outputs of this script
(outputidxstatstabulatefolder <- "outputs_minimap2_20200917_F2308_q48_kelpie20200916_vsearch97")
...
# parallel implementation runs in 105 secs.
plan(multisession) # uses all available cores
tictoc::tic()
genomecoverages_summ <- future_map(genomecov_files, loadFile2, .progress=TRUE); notify("Your loadfile2 function has finally finished!", "Message from R", speakIt=TRUE) 
tictoc::toc()
# rbind the list into a dataframe 
genomecoverages_summ <- do.call(rbind, genomecoverages_summ) 
...
envdataTosa <- read_csv(file.path("..", "08_reference_sequences_datasets", "biodiversity_site_info_vars_20200220.csv"))
...
(species <- select(idx_meta_genomecov_filtered_wide, starts_with(c("R343-70__", "R6801-4"))))
