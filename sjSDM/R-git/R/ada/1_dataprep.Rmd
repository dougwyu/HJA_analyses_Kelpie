...
env.scale.csv <- otuenv %>% select(!contains("__")) %>% 
  select(-SiteName, -trap, -period, -UTM_E, -UTM_N, -clearcut, -oldGrowthIndex) %>% 
...
#  [9] "YrsSinceDist"       "mean.NDVI"          "mean.EVI"           "mean.bright" 
# [13] "mean.green"         "mean.wet"           "mean.NDVI.scale"    "mean.EVI.scale"    
# [17] "mean.green.scale"   "mean.bright.scale"  "mean.wet.scale"     "l_Cover_2m_max"    
# [21] "l_Cover_2m_max_all" "l_Cover_2m_4m"      "l_Cover_2m_4m_all"  "l_Cover_4m_16m"    
# [25] "l_p25"              "l_p25_all"          "l_p95"              "l_p95_all"   
# [29] "l_rumple"  
