...
# note:  perhaps do not include the last line (rescale(log) because i might want to generate the FSL-corrected read table and only scale to quasiprobs when making the sjsdm input otu table. Do i really need to log? doublechk spikepipe paper 
