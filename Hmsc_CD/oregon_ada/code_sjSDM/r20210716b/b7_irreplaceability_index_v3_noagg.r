...
#beta.r.prob <- irrAB(x = pred.in.cl, pc = 0.90, type = "total", r = r.msk)
beta.r.prob.res <- irrAB(x = pred.in.cl, pc = 0.90, type = "total")
...
save(beta.r.prob.res, file = file.path(resFolder, "beta_res_noagg.rdata"))

# plot(beta.r.prob_ct)

load(file.path(resFolder, "beta_res_noagg.rdata"))
