...
setwd("C:/Users/55116479/Dropbox (Manchester Met)/R_online/transfer")
...
gis <- "C:/Users/55116479/Dropbox (Manchester Met)/R_online/transfer"
dir(gis)
...
# user  system elapsed # 5000 points
# 90.60    7.33   98.01 
# 98*100/60
head(vals_gt4_r250)
...
writeRaster(gt4_r500, filename = file.path(gis, "gt4_r30_r500.tif"), datatype = "FLT4S", overwrite = TRUE)
