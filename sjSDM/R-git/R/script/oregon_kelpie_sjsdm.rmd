...
# (lidar data)
lidar.env = read.csv(here('kelpie/lidar_data/biodiversity_site_info_multispectral_2020-04-13.txt'), header=T, sep=',', stringsAsFactors = F, na.strings='NA')
str(lidar.env)
	
# ('data_Feb_25' folder) 
otu.env1.noS = read.csv(here('kelpie/data_Feb_25/sample_by_species_table_F2308_minimap2_20200221_kelpie20200214.csv'), header=T, sep=',', stringsAsFactors = F, na.strings='NA')
	
otu.env1.spike = read.csv(here('kelpie/data_Feb_25/sample_by_species_corr_table_F2308_minimap2_20200221_kelpie20200214.csv'), header=T, sep=',', stringsAsFactors = F, na.strings='NA')
...
write.table(otu.env1.noS, here('kelpie/data_Feb_25/lidar_sample_by_species_table_F2308_minimap2_20200221_kelpie20200214.csv'), row.names=F, sep=',')
	
write.table(otu.env1.spike, here('kelpie/data_Feb_25/lidar_sample_by_species_corr_table_F2308_minimap2_20200221_kelpie20200214.csv'), row.names=F, sep=',')
	
write.table(lidar.env, here('kelpie/lidar_data/sjsdm_biodiversity_site_info_multispectral_2020-04-13.csv'), row.names= F, sep=',')
...
lidar.env = read.csv(here('kelpie/lidar_data/sjsdm_biodiversity_site_info_multispectral_2020-04-13.csv'), header=T, sep=',', stringsAsFactors = F, na.strings='NA')
str(lidar.env)
	
# ('data_Feb_25' folder, load data formatted for sjsdm) 
otu.env1.noS = read.csv(here('kelpie/data_Feb_25/lidar_sample_by_species_table_F2308_minimap2_20200221_kelpie20200214.csv'), header=T, sep=',', stringsAsFactors = F, na.strings='NA')
	
otu.env1.spike = read.csv(here('kelpie/data_Feb_25/lidar_sample_by_species_corr_table_F2308_minimap2_20200221_kelpie20200214.csv'), header=T, sep=',', stringsAsFactors = F, na.strings='NA')
...
write.table(otu.env1.noS.rel.abun, here('kelpie/data_Feb_25/relAbun_lidar_sample_by_species_table_F2308_minimap2_20200221_kelpie20200214.csv'), row.names=F, sep=',')
write.table(otu.env1.noS.present, here('kelpie/data_Feb_25/present_lidar_sample_by_species_table_F2308_minimap2_20200221_kelpie20200214.csv'), row.names=F, sep=',')
	
write.table(otu.env1.spike.present, here('kelpie/data_Feb_25/present_lidar_sample_by_species_corr_table_F2308_minimap2_20200221_kelpie20200214.csv'), row.names=F, sep=',')
write.table(otu.env1.spike.rel.abun, here('kelpie/data_Feb_25/relAbun_lidar_sample_by_species_corr_table_F2308_minimap2_20200221_kelpie20200214.csv'), row.names=F, sep=',')
...
# ('data_Feb_25' folder, load data formatted for sjsdm, present) 
otu.env1.noS.present = read.csv(here('kelpie/data_Feb_25/present_lidar_sample_by_species_table_F2308_minimap2_20200221_kelpie20200214.csv'), header=T, sep=',', stringsAsFactors = F, na.strings='NA')
	
otu.env1.noS.rel.abun = read.csv('kelpie/data_Feb_25/relAbun_lidar_sample_by_species_table_F2308_minimap2_20200221_kelpie20200214.csv', header=T, sep=',', stringsAsFactors = F, na.strings='NA')
	
otu.env1.spike.present = read.csv(here('kelpie/data_Feb_25/present_lidar_sample_by_species_corr_table_F2308_minimap2_20200221_kelpie20200214.csv'), header=T, sep=',', stringsAsFactors = F, na.strings='NA')
	
otu.env1.spike.rel.abun = read.csv(here('kelpie/data_Feb_25/relAbun_lidar_sample_by_species_corr_table_F2308_minimap2_20200221_kelpie20200214.csv'), header=T, sep=',', stringsAsFactors = F, na.strings='NA')
	

```

```{r explore Lidar data }
pdf(here('kelpie/R/graph/lidar_describe_EVI_NDVI.pdf'), height=5, width=5)
