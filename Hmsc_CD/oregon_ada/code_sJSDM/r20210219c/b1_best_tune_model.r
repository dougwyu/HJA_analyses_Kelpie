...
## get best tune run
# res <- read.csv(file.path(resFolder, "manual_tuning_sjsdm_5CV_M1S1_mean_AUC_qp_min_5_nSteps_1000.csv"))
res <- read.csv(file.path(resFolder,paste0("manual_tuning_sjsdm_5CV_M1S1_mean_AUC_", 
                           abund, 
                           "_min_",
                           minocc,
                           "_nSteps_",
