...
resFolder <-"code_sjSDM/r20210225b/results"
...
## Do tuning per k
  ...
  for(j in seq_len(noSteps)){
    ...
    model.train <- readRDS(file.path(resFolder,paste0("s-jSDM_tuning_model_", k, "CV_",i, "_tr_", j, "_", abund, ".rds")))
...
write.table(tune.results,
            file = file.path(resFolder,paste0("manual_tuning_sjsdm_", k, "CV_M1S1_", 
                                              abund, 
                                              "_min_",
                                              minocc,
                                              "_nSteps_",
...
write.table(tune.mean,
            file = file.path(resFolder,paste0("manual_tuning_sjsdm_", k, "CV_M1S1_mean_AUC_", 
                                              abund, 
                                              "_min_",
                                              minocc,
                                              "_nSteps_",
