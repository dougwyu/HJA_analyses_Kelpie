...
save(tsne, r, rSites1, rSites2, NAs, file = file.path(resFolder, "ord_tsne_res_cl_p100.rdata"))
...
writeRaster(rSites1, filename = file.path(resFolder, "tsne1_nopca_cl_p50.tif"), 
            datatype = "FLT4S", overwrite = T)
writeRaster(rSites2, filename = file.path(resFolder, "tsne2_nopca_cl_p50.tif"), 
            datatype = "FLT4S", overwrite = T)
# 

pdf(file.path(plotsFolder, "tsne_scatter_cl_p50.pdf"))
plot(tsne$Y, pch = ".")
dev.off()
