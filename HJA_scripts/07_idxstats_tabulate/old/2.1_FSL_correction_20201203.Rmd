...
Applies log(FSL) correction, qp transformation, remove some non-useful columns, subset to a specific malaise trap and period (e.g. M1S1), save the otuenv files, and create a table of sampling effort by site, trap, and period
