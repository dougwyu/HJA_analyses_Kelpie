...
# ... view data ...
par(mfrow=c(1,2))
hist(ori.env.train$elevation_f)
...
# save model data
save(s.otu.train,scale.env.train, XY.train,  s.otu.test, scale.env.test, XY.test, abund, file = paste0("Hmsc_CD/oregon_ada/data/yuanghen_mod_data_", abund, ".rdata"))
